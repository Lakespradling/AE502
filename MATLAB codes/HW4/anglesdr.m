...
%    rsite1   - ecef site1 position vector   m
%    rsite2   - ecef site2 position vector   m
%    rsite3   - ecef site3 position vector   m
%
%  outputs:
%    r        - tod position vector at t2   m
%    v        - tod velocity vector at t2   m/s
%
...
M1 = LTCMatrix(lon1, lat1);
M2 = LTCMatrix(lon2, lat2);
M3 = LTCMatrix(lon3, lat3);
